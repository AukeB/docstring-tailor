...
Args:
    ...
    octaves (int): Number of noise layers combined to produce detail in the output.
    persistence (float): Controls amplitude reduction across octaves (typically 0–1).
