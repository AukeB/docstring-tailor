...
| <div style="width:130px">Option</div> | <div style="width:50px">Type</div> | <div style="width:80px">Default</div> | Description |
|---|---|---|---|
...
| `0.2.0` | TBD | Feature update | Feature description |