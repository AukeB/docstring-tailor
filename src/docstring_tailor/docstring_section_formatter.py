...
class DocstringSectionFormatter:
    ...
    def _format_plain_paragraph(self, paragraph: str) -> str:
        ...
        Used for sections such as Note: and Example: where the body is indented one level beyond
    ...
    def _parse_items(self, section_content: str) -> list[str]:
        ...
        Detects item boundaries by indentation level. A new item starts whenever a line returns
        to the minimum indentation level found in the section. Continuation lines at a deeper
    ...
    def _format_item_section(self, section_name: str, section: str) -> str:
        ...
        Strips the section header, formats each item independently, and reassembles the section
    ...
    def format(self, content: str) -> str:
        ...
        Splits the content into sections on double newlines, formats each section independently,
        and rejoins them with a blank line between each.
